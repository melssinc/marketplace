...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Funcionalidad de Lightbox para ver imágenes individuales
    function abrirLightbox(src, alt) {
        let modal = document.getElementById('carouselLightbox');
        
        if (!modal) {
            modal = document.createElement('div');
            modal.id = 'carouselLightbox';
            modal.className = 'carousel-lightbox';
            modal.innerHTML = `
